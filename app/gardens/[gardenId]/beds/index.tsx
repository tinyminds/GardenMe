...
const styles = StyleSheet.create({
  ...
  growingRow: { gap: 6, borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 9 },
  growingMain: { gap: 2 },
  growingName: { fontWeight: "700" },
  finishChip: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6 },
  finishChipText: { fontWeight: "700", fontSize: 12 },
  finishChipDanger: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6 },
  finishChipDangerText: { fontWeight: "700", fontSize: 12 },
  historyHeader: { borderRadius: 8, paddingHorizontal: 8, paddingVertical: 6 },
  historyRow: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8, gap: 2 },
