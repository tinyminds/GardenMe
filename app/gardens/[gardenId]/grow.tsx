...
const styles = StyleSheet.create({
  ...
  suggestionMoreText: { fontWeight: "700", fontSize: 12 },
  wishRow: {
    borderWidth: 1,
    borderRadius: 10,
    padding: 10,
  ...
  descriptionToggleText: { fontSize: 12, fontWeight: "700" },
  descriptionBody: {
    marginTop: 2,
    paddingHorizontal: 8,
    paddingVertical: 6,
  ...
  qtyLabel: { fontWeight: "700", fontSize: 12 },
  qtyButton: {
    borderWidth: 1,
    borderRadius: 8,
    width: 26,
  ...
  qtyButtonText: { fontWeight: "800", fontSize: 14 },
  ...
  cloneInlineButtonText: { fontWeight: "700", fontSize: 12 },
  saveInlineButton: {
    borderWidth: 1,
    borderRadius: 10,
    paddingHorizontal: 10,
  ...
  saveInlineButtonText: { fontWeight: "700", fontSize: 12 },
  switchRow: {
    flexDirection: "row",
    alignItems: "center",
  ...
  removeButtonText: { fontWeight: "700", fontSize: 12, lineHeight: 14 },
  blockingOverlay: {
    position: "absolute",
    left: 0,
    right: 0,
