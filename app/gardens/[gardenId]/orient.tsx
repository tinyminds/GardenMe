...
const styles = StyleSheet.create({
  ...
  cardText: {},
  preview: { height: 340, borderRadius: 12, overflow: "hidden" },
  placeholder: {},
  row: { flexDirection: "row", gap: 8, flexWrap: "wrap" },
  button: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8 },
  ...
  saveButton: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12 },
  saveButtonText: { fontWeight: "800", textAlign: "center" },
});
