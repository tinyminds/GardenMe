...
const styles = StyleSheet.create({
  ...
  overviewList: { gap: 8 },
  overviewBedRow: { borderWidth: 1, borderRadius: 10, padding: 10, gap: 4 },
  overviewBedName: { fontWeight: "800" },
...
function formatEntryLabel(entry: GardenCropWishlistItemView): string {
  ...
  if (entry.varietyName?.trim()) return `${name} (${entry.varietyName.trim()})`;
  return name;
}
